...
function Main() {
  ...
  return (
    <>
      <div
        className={`flex relative  flex-col w-screen h-screen ${
          isDark ? "bg-white text-black" : "bg-[#2B2C37]"
        } text-white`}
      >
       <div  className={`w-screen h-screen absolute z-40 backdrop-blur-sm transition-all duration-500 ease-in-out ${  clearOpen ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-full' }`}><Clearboard handleClear={handleClear}/></div>
      <div  className={`w-screen h-screen absolute z-40 backdrop-blur-sm transition-all duration-500 ease-in-out ${  eidtOpen ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-full' }`}><Eidtboard  handleEidt={ handleEidt}/></div>
    <div  className={`w-screen h-screen absolute z-40 backdrop-blur-sm transition-all duration-500 ease-in-out ${  deleteOpen ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-full' }`}><Deleteboard handleDelete={handleDelete}/></div>
       <div  className={`w-screen h-screen absolute z-40 backdrop-blur-sm transition-all duration-500 ease-in-out ${  resetOpen ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-full' }`}><Resetboard handleReset={handleReset} /></div>
       <div  className={`w-screen h-screen absolute z-40 backdrop-blur-sm transition-all duration-500 ease-in-out ${  fromOpen ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-full' }`}><Inputfrom handleFrom={handleFrom} /></div>
       <div  className={`w-screen h-screen absolute z-40 backdrop-blur-sm transition-all duration-500 ease-in-out ${ addtaskOpen  ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-full' }`}><Addtask handleAddtask={handleAddtask} /></div>


          <div className={`w-full h-[16vh]  flex flex-row items-center ${
          isDark ? "bg-white text-black" : "bg-[#2B2C37]"
        } text-white`}>
           <button
          ...
          <header className="relative border-b border-gray-400 z-0 w-full p-5 ">
...
{navOpen && (<> <div className="absolute top-16 z-50    backdrop-blur-lg bg-black/0 left-2 border rounded-lg   border-gray-400">
                <div className=" flex  lg:hidden flex-col ">
                  ...
                  <p className="text-sm font-semibold text-gray-400">
                    ...
                    <div className="bg-transparent text-violet-500 p-2  hover:text-violet-400">
                      <p className=" font-semibold">+ Create New Boardnnnn</p>
                    </div> 
                    </div>
              ...
              <div className="flex items-center">
                ...
                <button onClick={handleDrop}>
                  ...
                  >
                   ...
                   {drop &&  (<div className="absolute z-50 right-8 text-sm lg:text-lg mt-2 lg:mt-2 bg-white rounded-lg shadow-lg w-44">
                      <ul className="p-0 lg:p-2 text-gray-700">
                          <li  >
                            <a href="#" onClick={handleEidt} className="block  lg:px-4 lg:py-2 hover:bg-gray-100 transition" > Edit Board  </a>
                          </li>
                          <li >
                            <a href="#" onClick={handleClear} className="block  lg:px-4 lg:py-2 hover:bg-gray-100 transition" > Clear Board </a>
                          </li>
                          <li >
                            <a href="#" onClick={handleDelete} className="block  lg:px-4 lg:py-2 hover:bg-gray-100 transition" > Delete Board  </a>
                          </li>
                          <li >
                            <a href="#" onClick={handleReset} className="block lg:px-4 lg:py-2 hover:bg-gray-100 transition" >Reset Boards </a>
                          </li>
                      </ul>
                    </div>)}
                </button>
          ...
          <div className="border-r hidden lg:flex w-[59.5vh]  border-gray-500">
              <div className="h-full hidden lg:flex flex-row ">
                ...
                <p className="text-lg font-semibold text-gray-400">
                  ...
                  <div className="bg-violet-500 w-full text-white rounded-r-full p-2 hover:bg-white hover:text-violet-800">
                  ...
                  <div onClick={handleAddtask} className="bg-transparent text-violet-500 rounded-r-full p-2  hover:text-violet-400">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"/>
        ...
        <div className="w-full h-fit overflow-hidden"><TodoColSec  isDark={() => isDark} handleSidebar={handleSidebar} /></div>
        </div>
      </div>
    </>
  );

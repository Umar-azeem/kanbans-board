...
{navOpen && (<> <div className="absolute top-16 z-50    backdrop-blur-lg bg-black/0 left-2 border rounded-lg   border-gray-400">
    ...
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"/>
              ...
              <div className="flex items-center">
                <button className="flex items-center gap-2 bg-violet-500 text-white hover:bg-white hover:text-violet-800 rounded-full px-2 py-1 lg:px-4 lg:py-2">
                  <svg
                    className="h-6 w-6"
                    fill="none"
                    stroke="currentColor"
                  ...
                  >
                   ...
                   {drop &&  (<div className="absolute z-50 right-8 text-sm lg:text-lg mt-2 lg:mt-2 bg-white rounded-lg shadow-lg w-44">
                      <ul className="p-0 lg:p-2 text-gray-700">
                          <li  >
                            <a href="#" className="block  lg:px-4 lg:py-2 hover:bg-gray-100 transition" > Edit Board  </a>
                          </li>
                          <li >
                            <a href="#" className="block  lg:px-4 lg:py-2 hover:bg-gray-100 transition" > Clear Board </a>
                          </li>
                          <li >
                            <a href="#" className="block  lg:px-4 lg:py-2 hover:bg-gray-100 transition" > Delete Board  </a>
                          </li>
                          <li >
                            <a href="#" className="block lg:px-4 lg:py-2 hover:bg-gray-100 transition" >Reset Boards </a>
                          </li>
                      </ul>
                    </div>)}
                </button>
          ...
          <div className="border-r hidden lg:flex w-[59.5vh]  border-gray-500">
              <div className="h-full hidden lg:flex flex-row ">
                ...
                <p className="text-lg font-semibold text-gray-400">
                  ...
                  <div className="bg-transparent text-violet-500 rounded-r-full p-2  hover:text-violet-400">
